...
// pqrs::osx::process_codesign_monitor v1.1.0

// (C) Copyright Takayama Fumihiko 2026.
// Distributed under the Boost Software License, Version 1.0.
// (See https://www.boost.org/LICENSE_1_0.txt)

// `pqrs::osx::process_codesign_monitor` can be used safely in a multi-threaded environment.
...
public:
  ...
  nod::signal<void(const std::optional<pqrs::osx::codesign::team_id>&)> team_id_changed;
  ...
  void async_start() {
    enqueue_to_dispatcher([this] {
      team_id_changed(initial_team_id_);
